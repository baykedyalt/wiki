...
Geliştirici ve Paket Yöneticisi Belgeleri [Fyra Developer](https://developer.fyralabs.com) sayfasına taşındı. Katkıda bulunmak isterseniz, [Katkıda bulunma](/en/contributing/contributorguide) bölümüne gidin.
...
Ultramarine Linux'ü indirmek isterseniz, [Ultramarine'i edinmek](/en/installation/getting) bölümüne gidin.
...
Fedora'nın ideolojiye bağlı kalmaya çalıştığı yer, (neredeyse) ücretsiz bir sistem sunmaktır, Ultramarine en az dayanıklılığa sahip modelde çalışır. That means we try to make it easy for the user, even if we have to ship some proprietary drivers and codecs that Fedora wouldn’t be comfy with out-of-box.
